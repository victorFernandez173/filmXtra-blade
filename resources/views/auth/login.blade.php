<x-layouts.basic>
    ...
    <x-slot:titulo>filmXtra - login</x-slot:titulo>

    <div class="h-[100vh] bg-cover bg-posters-fondo flex content-center">
        <div class="w-full flex flex-wrap justify-center content-center">
            ...
            <div class="w-full flex justify-center">
                <div class="w-64">
                    <a href="/">
                        <img src="{{asset('images/logo-blanco.png')}}" alt="logo de filmXtra">
                    </a>
                </div>
            </div>
